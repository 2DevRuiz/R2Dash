<template>
    <div class="w-full flex place-content-center">
        <div class="flex items-center p-4 rounded-lg shadow " :class="bgClass" role="alert">
            ...
            <div v-else class="ml-3 text-sm font-normal">
                ...
                <div class="mb-2 text-sm font-normal whitespace-pre-wrap" :class="textContentClass">{{ content }}</div>
            </div>
            <!-- <button
         @click="emit('remove')"
         type="button"
            ...
            <div class="ml-auto inline-flex flex-shrink-0 -mx-1.5 -my-1.5 p-1.5">
                <button @click="emit('remove')" type="button"
                    class=" items-center justify-center h-8 w-8 rounded-lg focus:ring-2 focus:ring-gray-300 "
                    :class="closeBtnClass">
                    <i class="fa-regular fa-circle-check fa-xmark fa-xl"></i>
