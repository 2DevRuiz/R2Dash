<template>
    <div class="flex h-screen w-full justify-center items-center text-center bg-gray-900 bg-cover bg-center bg-no-repeat"
        style="background-image:url('https://source.unsplash.com/photo-Dkn8-zPIbwo')">
        <div
            class=" bg-opacity-0 animate-fullBorder rounded-xl bg-white bg-[length:300%_400%] p-0.5 bg-gradient-to-r from-[#00BBE1] via-green-500 to-[#FDB618] mt-10 overflow-hidden">
            <!-- <div
            ...
            <div class="rounded-xl bg-gray-600 bg-opacity-100 px-16 py-10 shadow-lg  max-sm:px-8 ">
                ...
                <form class="mt-12" action="#" autocomplete="off" novalidate>
