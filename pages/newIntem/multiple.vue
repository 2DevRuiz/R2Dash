                    ...
                    <div class="w-full">
                        <div class="my-2 p-1 flex border border-gray-200 bg-white rounded ">
                            <div class="flex flex-auto flex-wrap">
                                ...
                                <div class="flex-1">
                                    <input placeholder="" v-model="filter" type="text" @focus="isOpen = true"
...
// const data = [ 'Python',  'Javascript',  'Ruby',  'JAVA',  'ASP.Net',  'C++',  'SQL',  'HTML'];
const addTag = (event: any, item?: any) => {
    if (item) {
        if (selected.value.indexOf(typeof item === 'object' ? item.name : item) === -1) {
            ...
            selected.value.splice(selected.value.indexOf(typeof item === 'object' ? item.name : item), 1)
        }
    }
    else {
